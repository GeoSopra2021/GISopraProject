...
public class Html_controller {
    ...
    @RequestMapping("/")
    public String dashboard_with_filter(@RequestParam(required = false, value = "trip-start", defaultValue="2015-04-15") String start,
            @RequestParam(required = false, value = "trip-end", defaultValue="2015-04-20") String end, Model model) {
